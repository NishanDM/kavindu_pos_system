...
export function InvoiceReports() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Invoice Reports Dashboard</h2>
        <p className="text-xs text-gray-600 mt-1">In here you are able to generate different kinds of reports related to Customer Invoices</p>
      </div>
