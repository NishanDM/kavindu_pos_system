...
export function CustomerCreditNotes() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Customer Credit Notes</h2>
        <p className="text-xs text-gray-600 mt-1">In here you can see customer credit notes</p>
      </div>
