...
export function SupplierSettlements() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Supplier Settlements Dashboard</h2>
        <p className="text-xs text-gray-600 mt-1">In here you can see supplier settlements</p>
      </div>
